...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"5747be28-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/address/index.vue?vue&type=template&id=136b5d24&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.selfType)?_c('div',{staticClass:"wl-address"},[_c('el-select',{attrs:{"placeholder":"请选择省份","value-key":"code","size":_vm.size},on:{"change":_vm.provinceChange},model:{value:(_vm.province_act),callback:function ($$v) {_vm.province_act=$$v},expression:"province_act"}},_vm._l((_vm.provinces),function(item){return _c('el-option',{key:item.code,attrs:{"label":item.name,"value":item}})}),1),_c('el-select',{attrs:{"size":_vm.size,"value-key":"code","placeholder":"请选择城市"},on:{"change":_vm.citysChange},model:{value:(_vm.city_act),callback:function ($$v) {_vm.city_act=$$v},expression:"city_act"}},_vm._l((_vm.citys),function(item){return _c('el-option',{key:item.code,attrs:{"label":item.name,"value":item}})}),1),_c('el-select',{attrs:{"size":_vm.size,"value-key":"code","placeholder":"请选择区/县"},on:{"change":_vm.countysChange},model:{value:(_vm.county_act),callback:function ($$v) {_vm.county_act=$$v},expression:"county_act"}},_vm._l((_vm.countys),function(item){return _c('el-option',{key:item.code,attrs:{"label":item.name,"value":item}})}),1)],1):_c('el-cascader',{attrs:{"size":_vm.size,"options":_vm.provinces,"props":_vm.cascader_props},on:{"change":_vm.getCascaderVal,"active-item-change":_vm.handleItemChange},model:{value:(_vm.cascader_val),callback:function ($$v) {_vm.cascader_val=$$v},expression:"cascader_val"}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/address/index.vue?vue&type=template&id=136b5d24&
